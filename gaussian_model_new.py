...
class GaussianModelNew:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        lancities = inverse_sigmoid(0.1 * torch.ones((fused_point_cloud.shape[0], 1), dtype=torch.float, device="cuda")) #######
    ...
    def training_setup(self, training_args): #######
        ...
        #print('training_args.include_feature: ',training_args.include_feature)
        #print('params: ',l)
