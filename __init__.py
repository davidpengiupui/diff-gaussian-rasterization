...
from scene.gaussian_model_new import GaussianModelNew # : GaussianModelNew
from utils.sh_utils import eval_sh

def render(viewpoint_camera, pc : GaussianModelNew, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
    ...
    return {"render": rendered_image[:3, :, :],
            "language_feature_image": rendered_image[3:, :, :],
